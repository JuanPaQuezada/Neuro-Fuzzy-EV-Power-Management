...
%Epoca,meta de Error, Step size inicial, tasa de decremento, tasa de%incremento
...
[trained_fis, train_error, step_size]=anfis(trainingData, initial_fis, training_options);
...
plot(train_error, 'LineWidth', 2, 'Color', [0.85, 0.325, 0.098]);
